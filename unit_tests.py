...
from reproducibility_utils import ReproducibilityManager, set_global_seed
...
class TestFileManagementUtils(unittest.TestCase):
    ...
    def test_save_result_structure(self):
        ...
        from file_management_utils import SaveResult, SaveStrategy
    ...
    def test_save_strategy_enum(self):
        ...
        from file_management_utils import SaveStrategy
...
class TestIntegrationWithExistingCode(unittest.TestCase):
    ...
    def test_reproducibility_integration(self):
        ...
        from reproducibility_utils import set_global_seed, get_model_params
